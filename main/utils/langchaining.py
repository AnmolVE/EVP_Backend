...
"Social Media Ads": """Create a compelling social media ad campaign that highlights the key pillars of our Employee Value Proposition (EVP). The campaign should target potential candidates at the pre-hire stage. Include a catchy headline, engaging visuals (described), and a clear call-to-action for candidates to learn more or apply.
""",
"EVP Blog Post": """Write a detailed blog post that showcases our company's unique Employee Value Proposition (EVP). The post should be engaging, informative, and reflect our brand's voice. Explain how these translate into real benefits for potential employees. Provide a strong conclusion that encourages readers to explore job opportunities with us.
""",
"EVP Brochure": """Develop a visually appealing brochure that outlines our Employee Value Proposition (EVP) for prospective candidates. The brochure should cover the core pillars of our EVP and should include testimonials, benefits, and a clear overview of what makes us stand out as an employer. Ensure the design is aligned with our brand identity.
""",
"EVP Infographic": """Design an infographic that succinctly summarizes our Employee Value Proposition (EVP). The infographic should be visually engaging and easy to understand, highlighting the key benefits and unique aspects of working with our company. Ensure the design is optimized for sharing on social media and in recruitment materials.
""",
...
""",
"Culture Video": """Create a script for a culture video that highlights our company’s work environment, values, and Employee Value Proposition (EVP). The video should tell a story that resonates with prospective candidates through employee interviews, office scenes, and examples of company culture in action. Include ideas for visuals and narration.
""",
...
""",
"Employee Testimonial Format": """Design a format for collecting and sharing employee testimonials that emphasize our Employee Value Proposition (EVP). The format should guide employees to share their experiences and it should be versatile enough to be used in blog posts, videos, or social media content.
""",
"Referral Letter": """Compose a referral letter template that employees can use to recommend our company to potential candidates. The letter should include an overview of our Employee Value Proposition (EVP) and explain why the company is a great place to work. Include a section for personal anecdotes or reasons the referrer believes the candidate would be a good fit.
""",
"Webinar - Get to know us": """Create an outline for a 'Get to Know Us' webinar aimed at potential candidates. The webinar should introduce our company, walk through our Employee Value Proposition (EVP). Plan for interactive elements like Q&A, polls, and a virtual tour to engage participants.
""",
"Career Fair": """Develop a plan for our presence at a career fair that highlights our Employee Value Proposition (EVP). The plan should include ideas for booth design, marketing materials. Ensure that our EVP is clearly communicated in all interactions and materials, with a focus on attracting top talent.
""",
...
""",
"Interview Process Overview Document": """Develop a document that outlines the entire interview process for candidates, from initial screening to final interviews. This document should clearly communicate what candidates can expect at each stage and how the process aligns with our Employee Value Proposition (EVP). Include sections that highlight our commitment such as transparency, candidate care, and fair evaluation.
""",
"Case Study Assignment": """Design a case study assignment that candidates can complete as part of the hiring process. The case study should be relevant to the role and include scenarios that reflect our Employee Value Proposition (EVP). Focus on challenges that highlight, such as innovation, problem-solving, or teamwork, and provide clear instructions and expectations.
""",
"Candidate Preparation Guide": """Create a preparation guide for candidates to help them get ready for their interviews. The guide should include tips on what to expect, how to prepare, and insights into our company culture and Employee Value Proposition (EVP). Emphasize how are reflected in our interview process, and provide resources that will help candidates feel confident and well-prepared.
""",
"Offer Stage Communication Plan": """Develop a communication plan template for the offer stage that hiring managers can use to ensure consistent and engaging communication with candidates. The plan should outline key touchpoints, messages, and timing, with a focus on reinforcing our Employee Value Proposition (EVP). Include strategies for addressing candidate concerns..
""",
"Candidate Journey Map": """Design a candidate journey map that visually represents the hiring process from the candidate's perspective. The map should highlight each stage of the process, key interactions, and how our Employee Value Proposition (EVP) is communicated at each step. Use the journey map to identify areas where we can enhance the candidate experience.
""",
"Hiring Manager Toolkit": """Create a comprehensive toolkit for hiring managers to use during the hiring process. The toolkit should include resources, templates, and best practices that align with our Employee Value Proposition (EVP). Focus on helping hiring managers effectively communicate to candidates, conduct interviews, evaluate candidates, and make decisions that support our overall talent strategy.
""",
"Job Description": """Develop a detailed job description template that is tailored to attract high-quality candidates. The job description should include a compelling overview of the role, key responsibilities, required qualifications, and benefits. Most importantly, it should prominently feature our Employee Value Proposition (EVP) to convey what makes our company unique as an employer. Include specific EVP elements that align with the role, and ensure the tone and language reflect our company culture and values. The job description should not only inform but also inspire potential candidates to apply.
""",
"Offer Letter": """Craft a personalized offer letter template that communicates our excitement to have the candidate join our team. The letter should include key details about the role and compensation, and it should reinforce our Employee Value Proposition (EVP). Include a welcoming tone and a section that highlights the next steps in the onboarding process.
""",
"Onboarding Guide": """Create an onboarding guide for new hires that introduces them to our company, culture, and Employee Value Proposition (EVP). The guide should be comprehensive yet easy to navigate, covering essential information such as company policies, team introductions. Include a warm welcome message and tips for making the most of their first few weeks.
""",
...
""",
"Role-Specific Training Modules": """Develop content for role-specific training modules that new hires will complete during their onboarding process. The modules should include practical training relevant to their position, while also incorporating elements of our Employee Value Proposition (EVP), that relate to career growth, culture, or company values.
""",
...
""",
"Company Handbook": """Create a company handbook that provides new hires with a comprehensive overview of our policies, procedures, and culture. The handbook should be aligned with our Employee Value Proposition (EVP) and include sections such as our commitment to diversity, professional development opportunities, and work-life balance. Ensure the tone is welcoming and inclusive.
""",
...
""",
"Welcome Kit Content": """Design the content for a welcome kit that new hires receive on their first day. The kit should include branded materials, a personal welcome note, and resources that reflect our Employee Value Proposition (EVP). Focus on creating a memorable and positive first impression.
""",
...
""",
"L&D Quizzes, Gamified Training Modules": """Develop a quiz or gamified training module that helps employees learn. The content should include key learning objectives, cover important material, and be designed in an engaging, interactive format. Reflect our Employee Value Proposition (EVP) by emphasizing how the activity supports continuous learning and skill development in a fun and motivating way.
""",
...
""",
"Leadership Communication Emails": """Compose an email from company leadership. The email should provide context or background for the message, and outline any next steps or action items for employees. Embed our Employee Value Proposition (EVP) by aligning the message with our company’s vision, goals, and commitment to employee engagement.
""",
"Crisis Communication Plan": """Develop a crisis communication plan that outlines how to manage and communicate. The plan should include details on key stakeholders, communication channels, and response steps. Ensure the plan reflects our Employee Value Proposition (EVP) by emphasizing the company’s commitment to transparency, employee safety, and support during challenging times.
""",
"Internal Survey Invitations": """Create an invitation for employees to participate. The invitation should explain the purpose of the survey, key areas of focus, and include a link to the survey. Embed our Employee Value Proposition (EVP) by highlighting the importance of employee feedback and how it will be used to improve the workplace.
""",
...
""",
"Recognition Emails, Team Event Invites": """Draft a recognition email or team event invitation. The email should include personalized elements to make the recipient feel valued. Reflect our Employee Value Proposition (EVP) by emphasizing how the recognition or event aligns with our company’s commitment to celebrating success and fostering team spirit.
""",
...
""",
"Pulse Surveys, Recognition Feedback": """Design a pulse survey or feedback form that gathers employee. The survey should include targeted questions that align with our Employee Value Proposition (EVP) by focusing on how well employees feel recognized and supported within the company.
""",
...
def get_tollgate2_data(company_data, key_themes_data, attribute_of_a_great_place_data, audience_wise_messaging_data, talent_insights_data):

    prompt = f"""I am giving you the data which i have stored in the sql database for a application.
        First analyze the given company data:
        Company Data: {company_data}

        Then analyze the Key Themes data:
        Key Themes Data: {key_themes_data}

        Then analyze the Attributes Data:
        Attributes Data: {attribute_of_a_great_place_data}

        Then analyze the Audience Data:
        Audience Data: {audience_wise_messaging_data}

        Then analyze the Talent Insights Data:
        Talent Insights Data: {talent_insights_data}

        After completely analyze the above information do the following using the information

        "Generate a Tollgate 2 summary PDF that provides an executive-level overview of the DEVELOP phase for stakeholder approval. The document should include:

        1. Objective of the DEVELOP Phase
        Explain that this phase focuses on validating key facts and figures about the company and its employer brand through STIMULAI's platform-generated Company Dataset.

        2. Key Insights Generated by STIMULAI:
        Company Dataset: A structured data set validating critical company facts and figures.
        Key Themes: Analysis of the dominant themes the company is projecting in the talent market.
        Audience Wise Messaging:
        Insights into how different talent cohorts perceive the company.
        Breakdown of the platform-generated messaging for each audience segment.
        Attributes of an Attractive Workplace:
        Summaries of how the company is performing against the nine key employer brand attributes.
        Talent Insights: Identification of key career motivators for the most sought-after talent roles.

        3. Governance & Approval Process
        Confirm that a progress report has been downloaded and shared with key stakeholders.
        Approval required to proceed to the DISSECT phase.
        Ensure the summary is structured, concise, and formatted for quick stakeholder review and sign-off."
        """
...
def get_tollgate3_data(analysis_data, alignment_data):
    prompt = f"""I am giving you the data which i have stored in the sql database for a application.
        First analyze the given analysis data:
        Analysis Data: {analysis_data}

        Then analyze the Alignment data:
        Alignment Data: {alignment_data}

        After completely analyze the above information do the following using the information

        "Generate a Tollgate 3 summary PDF that provides an executive-level overview of the DISSECT phase for stakeholder approval. The document should include:

        1. Objective of the DISSECT Phase
        Explain that this phase focuses on analyzing what's working well and what's not in the company's employer brand.

        2. Key Insights Generated by STIMULAI:
        Strengths & Gaps Analysis: Identifies what aspects of the employer brand are resonating positively and where misalignment or weaknesses exist.
        Messaging Alignment Assessment:
        Compares the company's intended employer brand positioning with what research data actually reveals.
        Evaluates whether the company is perceived as it wants to be known—or if gaps exist.
        Highlights areas where EVP messaging needs reinforcement or realignment based on data-driven insights.

        3. Governance & Approval Process
        Confirm that a progress report has been downloaded and shared with key stakeholders.
        Approval required to proceed to the DESIGN phase.
        Ensure the summary is concise, structured, and formatted for quick stakeholder review and sign-off."
        """
...
def get_tollgate4_data(evp_statement_themes_data, creative_direction_data, evp_definitions_data, evp_audits_data, evp_promises_data):
    prompt = f"""I am giving you the data which i have stored in the sql database for a application.
        First analyze the given EVP Statement data:
        EVP Statement Data: {evp_statement_themes_data}

        Then analyze the Creative Direction data:
        Creative Direction Data: {creative_direction_data}

        Then analyze the EVP Definition data:
        EVP Definition Data: {evp_definitions_data}

        Then analyze the EVP Audit data:
        EVP Audit Data: {evp_audits_data}

        Then analyze the EVP Promise data:
        EVP Promise Data: {evp_promises_data}

        After completely analyze the above information do the following using the information

        "Generate a Tollgate 4 summary PDF that provides an executive-level overview of the DESIGN phase for stakeholder approval. The document should include:

        1. Objective of the DESIGN Phase
        Explain that this phase shortlists the key themes that will form the EVP pillars and enables the creation of a final EVP statement.
        Summarize how this phase defines the creative direction, visual identity, and articulation of the EVP.

        2. Key Outputs from the DESIGN Phase:
        EVP Statement Generation:
        Shortlisted key themes that shape the EVP pillars.
        The final EVP statement recommended by the platform.
        Creative Direction & Visual Identity:
        Recommended tone, style, and brand identity for EVP rollout.
        How the EVP should be visually represented in employer branding materials.
        EVP Definition & Audit:
        What the EVP is—and what it is not.
        Where the EVP is believable vs. where it may be aspirational.
        EVP Promise - The Employee-Employer Equation:
        Defines the give-and-get relationship—what employees are expected to contribute and what they can expect in return.

        3. Governance & Approval Process
        Confirm that a progress report has been downloaded and shared with key stakeholders.
        Approval required to proceed to the DELIVER phase.
        """
