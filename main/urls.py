...
urlpatterns = [
    ...
    path("key-themes/<int:pk>/", KeyThemesRegenerateAPIView.as_view(), name='key-themes-specific'),
    ...
    path("regenerate-evp-statement-themes/<int:pk>", RegenerateEVPStatementThemes.as_view(), name="regenerate-evp-statement-themes"),
    path("generate-evp/", GenerateEVPStatementAPIView.as_view(), name='generate-evp'),
    path("regenerate-evp/<str:company_name>/", RegenerateEVPStatement.as_view(), name='regenerate-evp'),
