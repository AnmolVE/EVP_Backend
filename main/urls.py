...
urlpatterns = [
    ...
    path('key-themes/', KeyThemesAPIView.as_view(), name='key-themes-list'),
    path('key-themes/<str:company_name>/', KeyThemesSpecificAPIView.as_view(), name='key-themes-specific'),
    path('audience-wise-messaging/', AudienceWiseMessagingAPIView.as_view(), name='audience-wise-messaging-list'),
    ...
    path('swot-analysis/', SwotAnalysisAPIView.as_view(), name='swot-analysis-list'),
    path('swot-analysis/<str:company_name>/', SwotAnalysisSpecificAPIView.as_view(), name='swot-analysis-specific'),
    path('alignment/', AlignmentAPIView.as_view(), name='alignment-list'),
